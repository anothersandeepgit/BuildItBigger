 ...
 * on 2016-02-21 at 19:33:38 UTC 
 * Modify at your own risk.
 */

package com.end2end.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://jokebackend-1207.appspot.com/_ah/api/";
  ...
  public class SayHi extends MyApiRequest<com.end2end.backend.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, com.end2end.backend.myApi.model.MyBean.class);
